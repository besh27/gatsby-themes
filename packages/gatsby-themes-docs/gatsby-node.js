...
exports.createResolvers = ({ createResolvers }) => {
    createResolvers({
        DocsPage: {
            body: {
                type: 'String!', // needs to match the declaration from above.
                resolve: (source, args, context, info) => {
                    /*
                        source: the actual data or node
                        args: data format, filters, etc
                        context: information about the node
...
// after editting node, run 'yarn workspace theme-dev gatsby clean' to remove the public and cache dirs and run a fresh start. 